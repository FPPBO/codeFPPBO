...
public class FlappyBirdHard implements ActionListener, MouseListener, KeyListener{

    public static FlappyBirdHard flappybird;
    public final int WIDTH = 640, HEIGHT = 450;
    public RendererHard renderer;
    public Rectangle bird;
    public ArrayList<Rectangle> columns;
    public int ticks, yMotion, score;
    public boolean gameOver, started ;

    public FlappyBirdHard() {
        JFrame jframe = new JFrame();
        Timer timer = new Timer(20, this);

        renderer = new RendererHard();
        jframe.add(renderer);
    ...
    public void repaint(Graphics g){
        ...
        if(!started){
            g.drawString("Click to start!!", 40, HEIGHT/2);
        }
        if(gameOver){
