...
public class FlappyBirdEasy extends JPanel implements ActionListener, MouseListener, KeyListener {
    ...
    public FlappyBirdEasy(CardLayoutWindow parent, int areaWidth, int areaHeight, Bird birdType, int target) {
    	...
    	jbReturn.setActionCommand("ReturnEasy");
