...
public class MediumPanel extends JPanel {
	...
	private String fileNameClearMedium;
	...
	public MediumPanel (CardLayoutWindow parent, int areaWidth, int areaHeight,
		...
		targetMedium = new int[LEVEL];
		targetMedium[0] = 5;
		targetMedium[1] = 10;
		targetMedium[2] = 15;
		
		clearMedium = new Boolean[LEVEL];
	...
	public void setClearMedium(int index) {
		clearMedium[index] = true;
	...
	public void setfileNameClearMedium(String username) {
		fileNameClearMedium = "dataClearMedium" + username;
		loadClearMedium();
	}
