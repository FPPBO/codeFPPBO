...
public class FlappyBirdEasy implements ActionListener, MouseListener, KeyListener{

    public static FlappyBirdEasy flappybird;
    public final int WIDTH = 640, HEIGHT = 450;
    public RendererEasy renderer;
